...
using Grpc.Core;
using Ondewo.Survey.Client.Auth;
using Xunit;
...
namespace Ondewo.Survey.Client.Tests
{
    ...
    public class OndewoAuthTests
    {
        ...
        public async Task CreateBearerInterceptorAppendsTheTokenToCallMetadata()
        {
            ...
            await interceptor(new AuthInterceptorContext("https://grpc-survey.ondewo.com", "GetSurvey"), metadata);
        ...
        {
            AsyncAuthInterceptor interceptor = OndewoAuth.CreateBearerInterceptor(Token);
            var context = new AuthInterceptorContext("https://grpc-survey.ondewo.com", "GetSurvey");
